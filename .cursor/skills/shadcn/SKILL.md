...
5. **Use the token scale.** `text-sm`, `p-4`, `rounded-lg` — never arbitrary `text-[13px]`, `bg-[#…]`, `rounded-[10px]` ([design-tokens.mdc](../../rules/ui/design-tokens.mdc)).
...
- **Design tokens only.** Semantic colors + Tailwind scale — no arbitrary `text-[…]`, `bg-[…]`, hex, or raw palette. See [design-tokens.mdc](../../rules/ui/design-tokens.mdc).
